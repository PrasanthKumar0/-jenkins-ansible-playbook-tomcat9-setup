pipeline {
    ...
    stages {
        ...
        stage('Run Ansible Playbook') {
            steps {
                ansiblePlaybook credentialsId: 'Jenkins-Ansible', disableHostKeyChecking: true, installation: 'Ansible', inventory: 'nventory: '/etc/ansible/hosts', playbook: 'install_tomcat9.yml', vaultTmpPath: ''
            }
        }
    }
